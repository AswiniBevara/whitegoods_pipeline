...
///     received.
/// </summary>
/// <param name="handle">Handle to the json tree containing the Device Twin desired
/// properties.</handle>
//typedef void (*TwinUpdateFnType)(MULTITREE_HANDLE handle);

typedef void(*TwinUpdateFnType)(const char *childNode, const char * featureName, const char *payload);
/// <summary>
