...
- [2 IoT Solutions](#2-iot-solutions)
    ...
    - [2.2 Automated Solution](#22-automated-solutioq)
...
In White Goods solution we are monitoring the Household Appliances like Washing machine, Dishwasher, Refrigerators, Coffee Maker etc. By using this solution User will access the Multiple Devices remotely and can get the acknowledgement from the Devices status whether its turned On or Off. It also provides the device location and helps user for predictive maintenance of the Appliance.
